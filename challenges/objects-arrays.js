...
const universities = [];
graduates.forEach(function(college) {
...
*/
const populationTotal = zooAnimals.reduce(function(loaction, curPop) {
  return loaction + curPop.population;
}, 0);
